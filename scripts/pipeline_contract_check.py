...
AUTOMATION_MAP = {
    ...
    "news-daily.yml": ["news_ingest.py"],
    "newsletter-weekly.yml": ["generate_newsletter.py", "send_newsletter.py"],
...
REQUIRED_ENV_BY_SCRIPT = {
    ...
    "news_ingest.py": ["SUPABASE_URL", "SUPABASE_SERVICE_KEY"],
    "generate_newsletter.py": ["SUPABASE_URL", "SUPABASE_SERVICE_KEY"],
    "send_newsletter.py": ["SUPABASE_URL", "SUPABASE_SERVICE_KEY"],
