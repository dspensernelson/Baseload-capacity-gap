  ...
  return (
    <section style={{ maxWidth: '820px', marginTop: '3rem', paddingBottom: '4rem' }} className="centered">
      ...
      <div style={{ marginTop: '1.75rem' }}>
        ...
        <pre style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '6px', padding: '0.75rem', fontSize: '0.72rem', overflowX: 'auto', marginTop: '0.4rem' }}>{`<iframe src="https://baseload-capacity-gap.vercel.app/embed/gap" width="100%" height="320" style="border:0" title="Nuclear Pipeline Tracker — The Gap"></iframe>`}</pre>
      </div>
    </section>
  )
}
